...
class Get_Junction_Graph
{
	...
	public:
	Get_Junction_Graph(vector<vector<int> > vec_edges,vector<double> vec_weights,vector<vector<int> > pair_paths);
	~Get_Junction_Graph();
...
Get_Junction_Graph::Get_Junction_Graph(vector<vector<int> > vec_edges,vector<double> vec_weights,vector<vector<int> > pair_paths)
{
	Vec_edges=vec_edges;
