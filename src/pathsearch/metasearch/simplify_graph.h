...
public:
  ...
  void Statistic(string strand, string chr);
  vector<double> get_cov_distribution(pair<int,int> junc);
  double distance(vector<double> junc1, vector<double> junc2);
  double pearson(vector<double> junc1, vector<double> junc2);
  double cosine(vector<double> junc1, vector<double> junc2);
  double adcosine(vector<double> junc1, vector<double> junc2);
  double dot(vector<double> junc1, vector<double> junc2);
